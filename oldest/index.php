      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger active" href="http://menuikkousha.com/"><span>Home</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="http://menuikkousha.com/#about"><span>About</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="http://menuikkousha.com/menu.php"><span>Menu</span></a>
            </li>
          </ul>
        </div>
      </div>
            ...
            <div class="row">
				...
				<div class="col-md-3">
                    <div class="services-inner-box">
						<div class="ser-icon">
							<img src="uploads/food/<?=$a?>.jpg" class="img-fluid" alt="" />
						</div>
