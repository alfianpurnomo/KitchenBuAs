...
define('PATH_CMS', (!empty($_SERVER['HTTPS'])?'https://':'http://').$_SERVER['SERVER_NAME'].'/x-adm/');
define('CACHE_PREFIX','CmSFATTY_');
define('IMG_UPLOAD_MAX_SIZE', 102400000);
define('FILE_UPLOAD_MAX_SIZE', 102400000);
...
// global assets
define('GLOBAL_ASSETS_URL',PATH_CMS.'assets/'.TEMPLATE_DIR.'/');
...
define('FRONTEND_URL', 'http://foody.test/');
define('FRONTEND_ASSETS_DIR', FRONTEND_URL.'uploads/');
